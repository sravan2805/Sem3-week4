...
const BuyCredit = () => {
  ...
  return (
    <div className="min-h-[80vh] text-center pt-14 mb-10">
      ...
      <h1 className="text-center bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold mb-6 sm:mb-10">Choose the plan thats right for you</h1>
