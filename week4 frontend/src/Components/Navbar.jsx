...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between mx-4 py-3 lg:mx-44 '>
      <Link to='/'> <img src={assets.logo} className='w-32 sm:w-44 ' alt="" /></Link> 
      {
        isSignedIn?
        ...
        <button onClick={()=>openSignIn({})} className='bg-zinc-800 text-white items-center flex gap-4 px-4 py-2 sm:py-3 text-sm rounded-full '>
